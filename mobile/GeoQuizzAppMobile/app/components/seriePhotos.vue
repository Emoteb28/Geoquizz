        ...
        <RadSideDrawer ref="drawer">
            ...
            <GridLayout ~mainContent columns="*" rows="*">
                ...
                <StackLayout orientation="vertical" width="100%" height="100%"
                    ...
                    <ListView class="list-group" for="photo in thePhotos"
                        @itemTap="onItemTap" style="height:1250px" width="100%">
                        <v-template>
                            <FlexboxLayout flexDirection="row" class="list-group-item">
                                <Image :src="'http://7a1d673b.ngrok.io/uploads/'+photo.url"
                                    class="thumb img-circle" />
                                <Label :text="photo.desc" class="list-group-item-heading"
                                    style="width: 60%" />
                            </FlexboxLayout>
                        </v-template>
                    </ListView>
        ...
        methods: {
            ...
            getPhotos() {
                return new Promise((resolve, reject) => {
                    ...
                    axios
                        .get(
                            "http://7a1d673b.ngrok.io/series/" + this
                            .id + "/photos"
                        )
                        .then(response => {
