            ...
            <GridLayout ~mainContent columns="*" rows="*">
                ...
                <GridLayout rows="auto,auto,*,auto" columns="auto">
                    ...
                    <GridLayout row="0" ref="navStatusBar" class="navStatusBar"
                        backgroundColor="deepskyblue" verticalAlignment="top"
                        height="0" width="100%" rows="auto" columns="*,auto,auto,auto">
                        <Label col="0" row="0" class="status-title"></Label>
                    </GridLayout>

                    <GridLayout class="tabview" :class="selectedTabview==1?'active':''"
                        rows="*,auto" cols="auto" col="1" row="0" width="34%">
                        ...
                        <Label :class="selectedTabview==1?'active':''" row="1"
                            class="tabviewText"></Label>
                    </GridLayout <StackLayout row="2" orientation="vertical"
                        padding="">
                    ...
                    <StackLayout row="2" orientation="vertical" padding="">
                        <Button class="btnP" row="4" text="Take Picture" @tap="onTakePictureTap"
                            - padding="10" />
                        <Image row="2" :src="cameraImage" id="image" stretch="aspectFit"
                            margin="8" />
                    </StackLayout>
                    ...
                    <StackLayout row="3" orientation="vertical" padding="">
                        ...
                        <Button row="5" class="btnB" text="Send to backend"
                            @tap="createPhoto" padding="10" />
    ...
    export default {
        ...
        methods: {
            ...
            createPhoto() {
                ...
                var filePath = this.cameraImage.android;
                ...
                return new Promise((resolve, reject) => {
                    axios.defaults.headers.common["Authorization"] =
                        "Bearer " + this.token;
                    axios
                        .post("http://7a1d673b.ngrok.io/photos", {
                            image: imageFile,
